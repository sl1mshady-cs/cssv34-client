...
void RegisterUserMessages()
{
	...
	usermessages->Register( "ClientMod_KeyHintText", -1 );
	usermessages->Register( "ClientMod_BigSayText", -1 );
	usermessages->Register( "ClientMod_BigHudMsg", -1 );
	usermessages->Register( "ClientMod_SoundOverrides", -1 );
	usermessages->Register( "ClientMod_BigHudMsgBg", -1 );
}
