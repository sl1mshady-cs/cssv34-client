...
public:
	...
	virtual void PingServer( uint32 unIP, uint16 usPort, IServerPingResponse* pRequestServersResponse ) = 0;
	virtual void PlayerDetails( uint32 unIP, uint16 usPort, IServerPlayersResponse* pRequestServersResponse ) = 0;

	virtual void RemoveResponse(IServerPingResponse* resp, IServerPlayersResponse* resp2) = 0;
};
