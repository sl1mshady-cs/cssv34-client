...
import com.entityname.cssv34.MainActivity;
import com.entityname.cssv34.R;
...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
	...
	public void onRequestPermissionsResult( int requestCode,  String[] permissions,  int[] grantResults ) {
		...
		//			Toast.makeText( this, R.string.launcher_no_perms, Toast.LENGTH_LONG ).show();
		//			finish();
		//			return;
		//		}
		//	}
    ...
    public void init()
    {
        ...
        MainActivity.initNatives(this, getIntent());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Log.v(TAG, "No permissions for RECORD_AUDIO");
        }
