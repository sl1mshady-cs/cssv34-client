...
#else
static ConVar mat_dxlevel( "mat_dxlevel", "95", 0, "Current DirectX Level. Competitive play requires at least mat_dxlevel 90", false, 0, false, 0, true, 90, false, 0, NULL  );
#endif
